<div class="account-right">
    ...
    ?> 
			...
			<div class="form-group">
				<label for="exampleInputPassword3">订单类型</label> 
	...
	<div class="account-tab">
		<ul>
			<a href="/order/index"><li
				class="col-md-2 <?php if ($status == '') echo 'account-tab-hover';?>">全部</li></a>
			<a href="/order/index?status=0"><li
				class="col-md-2 <?php if ($status == '0') echo 'account-tab-hover';?>">未分配</li></a>
			<a href="/order/index?status=1"><li
				class="col-md-2 <?php if ($status == '1') echo 'account-tab-hover';?>">已分配</li></a>
			<a href="/order/index?status=2"><li
				class="col-md-2 <?php if ($status == '2') echo 'account-tab-hover';?>">服务中</li></a>
			<a href="/order/index?status=6"><li
				class="col-md-2 <?php if ($status == '6') echo 'account-tab-hover';?>">已完成</li></a>
		</ul>
	</div>
